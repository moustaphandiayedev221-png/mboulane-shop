  ...
  return (
    <main className="min-h-screen bg-[#FDFBF7]">
      ...
      <div className="mx-auto max-w-md px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-sm text-[#6b5d4f]">Accédez au suivi de vos commandes via un compte sécurisé.</p>
        ...
        <form
          ...
          className="mt-8 space-y-6 rounded-[5px] border border-[#ebe5dc] bg-white p-6 shadow-sm"
        >
