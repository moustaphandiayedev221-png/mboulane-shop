...
export default async function PaytechSuccessPage(props: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
      ...
      <div className="pb-16 pt-24 md:pt-32">
        <div className="mx-auto max-w-xl px-4 text-center sm:px-6 lg:px-8">
          <LuxuryPanel className="py-14">
            ...
            <h1 className="mb-4 font-serif text-4xl font-semibold tracking-tight text-[#3d3429]">Paiement reçu</h1>
            <p className="mb-8 text-lg font-light leading-relaxed text-[#6b5d4f]">
              Merci. Votre paiement a été enregistré. La commande sera visible dans vos commandes dès confirmation automatique.
            </p>
            {ref ? (
