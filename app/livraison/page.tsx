...
export const metadata: Metadata = {
  ...
  description:
    "Toutes les informations sur la livraison de nos produits : coûts, délais pour le Sénégal et l'international.",
}
  ...
  return (
    <LuxuryMain>
      ...
      <LuxuryHero
        ...
        subtitle="Où que vous soyez, MBOULANE veille à ce que vos articles arrivent avec soin."
      />
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 grid gap-8 md:grid-cols-2">
            ...
            <LuxuryPanel>
              ...
              <p className="mb-4 font-light leading-relaxed text-[#6b5d4f]">
                Nous expédions nos produits dans le monde entier (Europe, Amériques, reste de l&apos;Afrique) via DHL
                Express.
              </p>
              <ul className="space-y-2 text-sm font-light text-[#6b5d4f]">
                <li className="flex items-center gap-2">
          ...
          <LuxuryPanel className="mx-auto max-w-3xl text-center">
            ...
            <p className="font-light leading-relaxed text-[#6b5d4f]">
              ...
              Vous pourrez suivre vos commandes MBOULANE jusqu&apos;à votre porte.
            </p>
          </LuxuryPanel>
        </div>
      </section>
