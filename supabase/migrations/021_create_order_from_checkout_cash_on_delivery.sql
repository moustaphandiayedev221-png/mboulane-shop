-- Recrée la RPC create_order_from_checkout pour accepter uniquement cash_on_delivery.
-- Important : modifier un ancien fichier de migration ne met pas à jour une base déjà migrée,
-- donc on applique ce correctif via une nouvelle migration.
